            ...
            <v-container>
                ...
                <v-card border="opacity-50 sm" class="mx-auto" max-width="1200" rounded="xl" variant="text">
                    <template v-slot:title>
                        <div class="mb-5text-caption font-weight-bold ">Edit Data Kartu Keluarga</div>
                    </template>
                    ...
                    <template v-slot:text>
                        ...
                        <small class="text-caption text-medium-emphasis d-flex justify-space-between align-center">
                            ...
                            <v-col cols="3" md="2" sm="4">
                                <v-btn @click="putKk" rounded="" block>Save</v-btn>
                            </v-col>
                        </small>
                    </template>
                </v-card>
...
export default {
    ...
    methods: {
        ...
        putKk() {
            ...
            self.id = this.$route.params.id
            axios
                .put("http://127.0.0.1:8000/api/kk/" + self.id, self.kk)
                .then(function (response) {

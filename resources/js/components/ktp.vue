    ...
    <v-layout class="rounded rounded-md">
      ...
      ></v-navigation-drawer> -->
        ...
        <v-navigation-drawer expand-on-hover rail color="grey-darken-1" width="200" permanent>
            <v-list>
                <v-list-item prepend-avatar="" subtitle="snrypblc@gmailcom"
        ...
        <v-main class="d-flex align-center justify-center" style="min-height: 300px;">
            <v-data-table :headers="headers" :items="desserts" :sort-by="[{ key: 'calories', order: 'asc' }]">
                <template v-slot:top>
                    <v-toolbar flat>
                        <v-toolbar-title>Masukan Data Kartu Tanda Penduduk</v-toolbar-title>
                                ...
                                <v-card-text>
                                    <v-container>
                                        <v-row>
                                            ...
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.lahir"
                                                    label="Tmpt/Tgl Lahir"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.kelamin"
                                                    label="Jenis Kelamin"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.darah"
                                                    label="Gol Darah"></v-text-field>
                                            </v-col>
                                            <!-- new -->
                                            <v-col cols="12" md="9" sm="6">
                                            ...
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.rtrw" label="RT/RW"></v-text-field>
                                            </v-col>

                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.desa"
                                                    label="Desa/Kelurahan"></v-text-field>
                                            </v-col>

                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.kecamatan"
                                            ...
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.status"
                                                    label="Status Perkawinan"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" md="9" sm="6">
                                            ...
                                            <v-col cols="12" md="9" sm="6">
                                                <v-text-field v-model="editedItem.kewarganegaraan"
                                                    label="Kewarganegaraan"></v-text-field>
                                            </v-col>
                        ...
                        <v-dialog v-model="dialogDelete" max-width="500px">
                            <v-card>
                                <v-card-title class="text-h5">Apakah anda yakin ingin menghapus data?</v-card-title>
                                <v-card-actions>
                                    <v-spacer></v-spacer>

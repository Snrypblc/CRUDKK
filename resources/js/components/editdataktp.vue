            ...
            <v-container>
                ...
                <v-card border="opacity-50 sm" class="mx-auto" max-width="1200" rounded="xl" variant="text">
                    <template v-slot:title>
                        <div class="mb-5text-caption font-weight-bold ">Edit Kartu Tanda Penduduk</div>
                    ...
                    <template v-slot:text>
                        <v-container>
                            <v-row>
                                <v-col cols="12" md="4" sm="6">
                                    <v-text-field v-model="ktp.nik" label="NIK" placeholder="NIK"
                        ...
                        <small class="text-caption text-medium-emphasis d-flex justify-space-between align-center">
                            ...
                            <v-col cols="1" md="2" sm="4">
                                <v-btn @click="this.$router.back(-1)" rounded="" block>Cancel</v-btn>
                            </v-col>
                            <v-col cols="3" md="2" sm="4">
                                <v-btn @click="putKTP" rounded="" block>Save</v-btn>
                            </v-col>
                        </small>
                    </template>
                </v-card>
...
export default {
    ...
    methods: {
        ...
        putKTP() {
            ...
            self.id = this.$route.params.id
            axios
                .put("http://127.0.0.1:8000/api/ktp/" + self.id, self.ktp)
                .then(function (response) {
